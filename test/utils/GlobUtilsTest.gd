...
func glob_match_repo_gitignore_rules_stay_in_sync_test() -> void:
	...
	var expected_rules: Array[String] = [
		".gai/", ".dependency/",
		".cursor/skills/humanizer", ".cursor/skills/humanizer-zh",
		".godot/", ".nomedia", ".import/", "export.cfg", "export_credentials.cfg", "*.tmp",
...
func glob_match_repo_gitignore_positive_cases_test() -> void:
	var cases: Array = [
		...
		[".cursor/skills/humanizer", ".cursor/skills/humanizer/SKILL.md"],
		[".cursor/skills/humanizer-zh", ".cursor/skills/humanizer-zh/references/a.md"],
...
func glob_match_repo_gitignore_negative_cases_test() -> void:
	var cases: Array = [
		...
		[".cursor/skills/humanizer", ".cursor/skills/humanizer-extra/SKILL.md"],
		[".cursor/skills/humanizer-zh", ".cursor/skills/humanizer/readme.md"],
