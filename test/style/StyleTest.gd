...
func ColorBase_follow_theme_test() -> void:
	...
	assert(ColorBase.recessed_surface == ColorBase.DARK_RECESSED_SURFACE)
	assert(ColorBase.inset_surface == ColorBase.DARK_INSET_SURFACE)
	...
	assert(ColorBase.medium_border == ColorBase.DARK_MEDIUM_BORDER)
	...
	assert(ColorBase.selection_surface == ColorBase.DARK_ELEVATED_SURFACE.lerp(ThemeColor.accent_solid(), ColorBase.DARK_SELECTION_MIX))

	ThemeColor.current_theme = ThemeColor.ThemeEnum.LIGHT
	ColorBase.refresh()
	assert(ColorBase.background == ColorBase.LIGHT_BACKGROUND)
	assert(ColorBase.recessed_surface == ColorBase.LIGHT_RECESSED_SURFACE)
	assert(ColorBase.inset_surface == ColorBase.LIGHT_INSET_SURFACE)
	...
	assert(ColorBase.medium_border == ColorBase.LIGHT_MEDIUM_BORDER)
	...
	assert(ColorBase.selection_surface == ColorBase.LIGHT_ELEVATED_SURFACE.lerp(ThemeColor.accent_solid(), ColorBase.LIGHT_SELECTION_MIX))
